...
#define CMDS_ADC_NMEAN_DEFAULT 4   // Minimal mean-values              * CMDS_ADC_MDELT_DEFAULT (=25ms) = 100ms
...
#define CMDS_ADC_MDELT_DEFAULT 25  // ms                                * CMDS_ADC_NMEAN_DEFAULT (=4 Pnts) = 100ms
